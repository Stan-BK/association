<template>
  <div>
    ...
    <nav v-if="isNeedIntersection">
      <nuxt-link class="route" :to="toRouteName" :style="{ 'transform': routeName === 'Announcement' ? 'translate(-50%, 0)' : '' }">
        ...
        <p class="icon text">文章</p>
        <p class="icon text">公告</p>
      </nuxt-link>
    </nav>
  </div>
</template>
